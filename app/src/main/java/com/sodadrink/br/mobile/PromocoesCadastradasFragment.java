 ...
 */
public class PromocoesCadastradasFragment extends Fragment {

    String UrlMostrarPromocoesCadastradas = Enderecos.UrlMostrarPromocoesCadastradas();

    ListView listViewPromocoesCadastradas;

    int id_cliente;

    public PromocoesCadastradasFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_promocoes_cadastradas, container, false);

        listViewPromocoesCadastradas = (ListView)view.findViewById(R.id.listViewPromocoesCadastradas);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, UrlMostrarPromocoesCadastradas, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if(jsonObject.names().get(0).equals("PROMOCAO")){
                        ...
                        for(int i = 0; i < jsonArray.length(); i++){
                            ...
                            ListView listViewPromocao = (ListView)view.findViewById(R.id.listViewPromocoesCadastradas);
